...
--data_name DIV2K --model_name Cluster --num_points $num_points --iterations 50000 --save_imgs && \

CUDA_VISIBLE_DEVICES=0 python train_quantize.py -d $data_path \
--data_name DIV2K --model_name GaussianImage_RS --num_points $num_points --iterations 10000 --save_imgs \
